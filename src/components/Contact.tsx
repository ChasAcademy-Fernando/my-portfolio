...
export default function Contact() {
  ...
  return (
    <div className='h-screen flex relative flex-col text-center md:text-left md:flex-row  max-w-7xl px-10  justify-center  mx-auto items-center'>
      <h3 className=' hidden sm:inline-flex absolute top-24 uppercase tracking-[20px] text-white text-2xl text-center'>
        Contact
      </h3>
        ...
        >
          <div className=' flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2'>
            <input
              ...
              bg-slate-400/10 rounded-sm border-b px-6 py-4 border-[#6e6e6e] text-gray-500 placeholder-gray-400 transition-all focus:border-[#f7ab0a]/40 focus:text-[#f7ab0a]/60 hover:border-[#f7ab0a]/40'
            />
            <input
              required={true}
              placeholder='Email'
              ...
              name='user_email'
              type='email'
              className=' outline-none bg-slate-400/10 rounded-sm border-b px-6 py-4 border-[#6e6e6e] text-gray-500 placeholder-gray-400 transition-all focus:border-[#f7ab0a]/40 focus:text-[#f7ab0a]/60 hover:border-[#f7ab0a]/40'
            />
          </div>
          ...
          <textarea
            ...
            className='outline-none bg-slate-400/10 rounded-sm border-b px-6 py-4 border-[#6e6e6e] text-gray-500 placeholder-gray-400 transition-all focus:border-[#f7ab0a]/40 focus:text-[#f7ab0a]/60 hover:border-[#f7ab0a]/40'
          />
          <button className=' bg-orange-400/80 py-5 px-10 rounded-md text-black font-bold text-lg hover:opacity-50'>
            Submit
          </button>
        </form>
      </div>
